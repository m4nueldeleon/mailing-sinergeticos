...
export function Sidebar({
  ...
  useEffect(() => {
    setColapsada(localStorage.getItem("axis-sidebar") === "colapsada");
  }, []);
  function toggle() {
    setColapsada((v) => {
      localStorage.setItem("axis-sidebar", v ? "abierta" : "colapsada");
      return !v;
    });
  }
      ...
      >
        ...
        {!colapsada ? (
          <span className="font-display text-lg font-bold tracking-tight">
            Synergy <span className="text-[var(--accent)]">Axis</span>
          </span>
        ) : null}
      </Link>
